...
<div class="py-8">
    <div class="max-w-7xl mx-auto">
                            ...
                            @if ($data->count())
                                @foreach ($data as $item)
                                    <tr class="text-gray-700 text-sm">
                                        ...
                                        <td class="px-6 py-4">{{ $item->breadth }}</td>
        ...
        <x-jet-dialog-modal wire:model="modalFormVisible">
            ...
            <x-slot name="content">
                <div class="mt-4">
                    <x-jet-label for="" value="{{ __('Position') }}"/>
                    <x-jet-input wire:model="position" id="" class="block mt-1 w-full text-gray-600" type="number"/>
                    <x-jet-input-error for="position" class="mt-2"/>
                </div>
                <div class="mt-4">
                    <x-jet-label for="" value="{{ __('Item') }}"/>
                    <x-jet-input wire:model="item" id="item" class="block mt-1 w-full text-gray-600" type="text"/>
                    <x-jet-input-error for="item" class="mt-2"/>
                </div>
                <div class="mt-4">
                    <x-jet-label for="" value="{{ __('Length') }}"/>
                    <x-jet-input wire:model="length" id="" class="block mt-1 w-full text-gray-600" type="number"/>
                    <x-jet-input-error for="length" class="mt-2"/>
                </div>
                <div class="mt-4">
                    <x-jet-label for="" value="{{ __('Breadth') }}"/>
                    <x-jet-input wire:model="breadth" id="" class="block mt-1 w-full text-gray-600" type="number"/>
                    <x-jet-input-error for="breadth" class="mt-2"/>
                </div>
                <div class="mt-4">
                    <x-jet-label for="" value="{{ __('Height') }}"/>
                    <x-jet-input wire:model="height" id="" class="block mt-1 w-full text-gray-600" type="number"/>
                    <x-jet-input-error for="height" class="mt-2"/>
                </div>
                <div class="mt-4">
                    <x-jet-label for="" value="{{ __('Volume') }}"/>
                    <x-jet-input wire:model="volume" id="" class="block mt-1 w-full text-gray-600" type="number"/>
                    <x-jet-input-error for="volume" class="mt-2"/>
                </div>
            </x-slot>
