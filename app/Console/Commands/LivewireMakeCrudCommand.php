...
class LivewireMakeCrudCommand extends Command
{
    /**
     ...
     */
    protected string|array|null $nameOfTheClass;
    protected string|array|null $nameOfTheModelClass;
     ...
     * @throws FileNotFoundException
     */
    protected function generateLivewireCrudClassFile(): bool
    {
     ...
     * @return false
     */
    protected function generateLivewireCrudViewFile(): bool
    {
        // Set the origin and destination for the livewire class file
